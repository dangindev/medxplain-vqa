...
class ReasoningTemplates:
    ...
    def _init_reasoning_flows(self) -> Dict:
        ...
        return {
            ...
            'attention_guided': {
                ...
                'confidence_propagation': 'attention_weighted'
            },
            ...
            'comparative_analysis': {
                ...
                'confidence_propagation': 'differential_weighted'
            }
        }
    ...
    def get_reasoning_flow(self, flow_type: str) -> Dict:
        ...
        Args:
            flow_type: Type of reasoning flow
            
        Returns:
            Reasoning flow dictionary
        """
    ...
    def format_reasoning_step(self, step_type: str, step_data: Dict) -> Dict:
        ...
        Args:
            step_type: Type of reasoning step
            step_data: Data to fill template
            
        Returns:
            Formatted reasoning step
        """
    ...
    def create_reasoning_chain(self, flow_type: str, steps_data: List[Dict]) -> Dict:
        ...
        Args:
            flow_type: Type of reasoning flow to use
        ...
        reasoning_chain['overall_confidence'] = self._calculate_chain_confidence(
            reasoning_chain['steps'], 
            flow_info['confidence_propagation']
        )
        
        return reasoning_chain
    
    def _calculate_chain_confidence(self, steps: List[Dict], 
        ...
        if propagation_method == 'multiplicative':
            # Multiplicative - confidence decreases with each step
            overall = 1.0
            ...
            if len(step_confidences) > 0:
                # Give more weight to differential and conclusion steps
    ...
    def add_evidence_citations(self, reasoning_step: Dict, 
        ...
        Args:
            reasoning_step: Formatted reasoning step
            evidence_links: List of evidence link dictionaries
            
        Returns:
            Reasoning step with evidence citations
        """
    ...
    def validate_reasoning_chain(self, reasoning_chain: Dict) -> Dict:
        ...
        for i in range(1, len(steps)):
            ...
            if current_conf > previous_conf + 0.3:
                consistency_issues += 1
                validation['issues'].append(f"Step {i+1}: Confidence increase without justification")
        
        validation['consistency_score'] = max(0, 1.0 - (consistency_issues * 0.2))
