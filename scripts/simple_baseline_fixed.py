#!/usr/bin/env python
"""
🎯 FIXED BASELINE COMPARISON: Torch compatibility + fallback metrics
"""
...
class SimpleBaselineFixed:
    ...
    def load_blip_model(self, model_path):
        """Load BLIP model với torch compatibility fix"""
...
def main():
    print("🎯 Running BLIP-only Baseline Comparison (Fixed)")
    print("="*45)
